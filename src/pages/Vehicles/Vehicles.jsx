...
const Vehicles = () => {
  ...
  return (
    <>
      ...
      <div
        className="card w-75 mb-3 border-0 ms-auto shadow-lg me-auto"
        style={{ marginTop: "140px" }}
      >
        <div
          className="card-body position-relative d-flex flex-column align-items-center"
          style={{ height: "75vh" }}
        >
          <div
            className="cards w-100 d-flex flex-column mt-3 align-items-center overflow-y-scroll"
            style={{ height: "80%" }}
          >
            {user.vehicles_IDS.length === 0 ? (
              <p className="card-text" style={{ justifySelf: "center" }}>
          ...
          <div
            ...
            id="addVehicles"
            aria-hidden="true"
            aria-labelledby="addVehiclesLabel"
            tabIndex="-1"
          >
            <div className="modal-dialog modal-dialog-centered modal-xl">
              <div className="modal-content">
                <div className="modal-header">
                  <h1 className="modal-title fs-5" id="addVehiclesLabel">
                    New Vehicle
                  </h1>
                  <button
                    type="button"
