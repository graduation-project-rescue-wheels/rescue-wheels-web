...
const Settings = () => {
    ...
    let passValidationSchema = YUP.object({
        ...
        newPassword: YUP.string().required("Password is required").min(6, "Password must be at least 6 characters").matches(/^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*])(?=.{8,})/, "   & At least one lowercase letter At least one uppercase letter At least one digit At least one special character (in the set !@#$%^&*)  Minimum length of 8 characters"),
        ...
        <>
            ...
            <div className="d-flex flex-column align-items-center" style={{ marginTop: "100px" }}>
                ...
                <div className="tab-content w-75 shadow-lg" id="nav-tabContent">
                            ...
                            <div className="row g-0">
                                <div className="col-md-4 d-flex flex-column align-items-center mt-3">
                                    ...
                                    >
                                        {
                                            user.profilePic ?
                                                <img src={img} alt="" className="rounded-circle pic w-100" />
                                                :
                                                <img src={img} alt="" className="rounded-circle pic w-100" />
                                        }
                                        <input
                                ...
                                <div className="col-md-8">
                                    <div className="card-body">
                                        <form className="row g-3" onSubmit={InfoUpdateForm.handleSubmit}>
                                            <Input
                                                text={"First Name"}
                                                type='firstName'
                                                name='firstName'
                                            ...
                                            <button
                                                ...
                                                style={{ backgroundColor: '#e48700', borderBlockColor: '#e48700', boxShadow: '1px 1px 1px #e48700', color: "white" }}
                                            >
                                                Update
                                            </button>
                                        </form>
                    ...
                    <div className="tab-pane fade" id="nav-privacy-settings" role="tabpanel" aria-labelledby="nav-privacy-settings-tab" tabIndex="0">
