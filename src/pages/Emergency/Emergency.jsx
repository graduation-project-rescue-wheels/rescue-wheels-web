  ...
  const findAllNeededData = async () => {
    ...
    if (userData.payload.data.onGoingRequestId) {
      const res = await dispatch(
        GetRequestById(userData.payload.data.onGoingRequestId)
      );
    ...
    <div>
      ...
      <div className="position-relative w-100" style={{ height: "90vh" }}>
        ...
        <div
          ...
          className="rounded-4 d-flex py-4 justify-content-center align-items-end w-25 bg-white border p-2 border-2 position-absolute"
        >
          {UserHaveRequest ? (
            <div>
              <div className="w-100">
                {responder ? (
                  <div>
                    <LoaderProgress />
                    <h5 className="mt-3">
                      {responderData.firstName +
                        " " +
                        responderData.lastName +
                        " "}{" "}
                      is on his way
                    </h5>
                  </div>
            ...
            <div>
              ...
              >
                <option>Choose a issue type</option>
              ...
              <button
                className="btn btn-warning my-5 w-100"
                onClick={handleAddRequset}
              >
                Request
              </button>
            </div>
