...
const RepairCenter = () => {
  ...
  return (
    ...
    <div className={[style.bgLeft,"col-md-6 d-none d-lg-block"].join(" ")}>
        ...
        <div style={{overflow:'auto'}} className={[style.loginFormContainer, "flex-column col-md-6"].join(" ")}>
              <div className=" mt-3">
              <h6 className={style.h6}>  Sign Up As RepairCenter</h6>
