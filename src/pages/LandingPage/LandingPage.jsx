...
const LandingPage = () => {
  // useEffect(() => {
  //   axios.get(`${import.meta.env.VITE_SERVER_URL}/user/testPayment`).then(function (response) {
  //     // handle success
    ...
    <div className="">
      ...
      <div className="container  p-0" id="aboutUs">
        <div className="row m-0  p-0 d-flex justify-content-center align-items-center">
          <div className="col-md-6">
            ...
            <h1
              className="fw-bold"
              style={{ fontSize: "65px", color: "#362e93" }}
            >
              EVEN AT YOUR <br /> DOORSTEP
            </h1>
            <p className="text-secondary my-3 mb-5">
              We provide emergency services to a fully equipped car workshop at
              the chosen time and location, with experienced technicians,
              high-quality tools, competitive prices and maintenance centers.
              You can book an appointment at any time at any maintenance center.
            </p>
            <Link
              to={"/signUp"}
              className="applyBtn p-3 mt-5"
              style={{ backgroundColor: "#362e93" }}
            >
              Apply With Us
      ...
      <div className="container mt-5 p-0" id="services">
        ...
        <div className="text-center mt-5">
          <h5
            className="fw-light"
            style={{ fontSize: "25px", color: "#362e93" }}
          >
            Servicing and repair the Area’s
          </h5>
          <h5
            className="fw-bold mb-5"
            style={{ fontSize: "40px", color: "#362e93" }}
          >
            Most Popular Brands
          </h5>
          <Brands />
      ...
      <div className="container mb-5">
        <div className="text-center">
          <h5
            ...
            style={{ fontSize: "25px", color: "#362e93" }}
          >
            Download our App now and enjoy our services
          </h5>
      ...
      <div className=" py-5" style={{ backgroundColor: "#362e93" }}></div>
    </div>
  );
};
